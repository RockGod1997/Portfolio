        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                ...
                <div className="bg-white bg-opacity-30 p-6 rounded-xl shadow-lg">
                    ...
                    <p className="text-gray-300 dark:text-gray-300">Collects and display real time weather and temperature sensor information.</p>
                    <div className="mt-4 flex items-center">
                        <a href="https://github.com/RockGod1997/urban-app" target="_blank" rel="noopener noreferrer" className="text-blue-500 dark:text-blue-400 hover:underline flex items-center">
                            <Image src="/github.svg" alt="GitHub" width={16} height={16} className="filter invert mr-2 transform hover:rotate-12 transition-transform duration-300" />
                            View on GitHub
                        </a>
                    </div>
                ...
                <div className="bg-white bg-opacity-30 p-6 rounded-xl shadow-lg">
                    ...
                    <p className="text-gray-300 dark:text-gray-300">A maze generator + solver using A*, BFS, DFS, MDP Value and Policy Iterations algorithms.</p>
                    <div className="mt-4 flex items-center">
                        <a href="https://github.com/RockGod1997/maze-game" target="_blank" rel="noopener noreferrer" className="text-blue-500 dark:text-blue-400 hover:underline flex items-center">
                            <Image src="/github.svg" alt="GitHub" width={16} height={16} className="filter invert mr-2 transform hover:rotate-12 transition-transform duration-300" />
                            View on GitHub
                        </a>
                    </div>
