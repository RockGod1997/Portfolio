                ...
                <SwiperSlide>
                    <section className="w-full flex flex-col items-center">
                        ...
                        <ul className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-center font-semibold items-center lg:gap-4">
                            <li className="bg-gray-100 bg-opacity-30 w-[100px] h-[100px] rounded-full border border-gray-400 hover:bg-blue-500 hover:text-white hover:shadow-lg transition-colors duration-300 flex items-center justify-center text-xs sm:text-base">JavaScript</li>
                            <li className="bg-gray-100 bg-opacity-30 w-[100px] h-[100px] rounded-full border border-gray-400 hover:bg-blue-500 hover:text-white hover:shadow-lg transition-colors duration-300 flex items-center justify-center text-xs sm:text-base">React Native</li>
                            <li className="bg-gray-100 bg-opacity-30 w-[100px] h-[100px] rounded-full border border-gray-400 hover:bg-blue-500 hover:text-white hover:shadow-lg transition-colors duration-300 flex items-center justify-center text-xs sm:text-base">Angular</li>
                            <li className="bg-gray-100 bg-opacity-30 w-[100px] h-[100px] rounded-full border border-gray-400 hover:bg-blue-500 hover:text-white hover:shadow-lg transition-colors duration-300 flex items-center justify-center text-xs sm:text-base">CSS</li>
                            <li className="bg-gray-100 bg-opacity-30 w-[100px] h-[100px] rounded-full border border-gray-400 hover:bg-blue-500 hover:text-white hover:shadow-lg transition-colors duration-300 flex items-center justify-center text-xs sm:text-base">HTML5</li>
                            <li className="bg-gray-100 bg-opacity-30 w-[100px] h-[100px] rounded-full border border-gray-400 hover:bg-blue-500 hover:text-white hover:shadow-lg transition-colors duration-300 flex items-center justify-center text-xs sm:text-base">Python</li>
                        </ul>
                    </section>
                </SwiperSlide>
