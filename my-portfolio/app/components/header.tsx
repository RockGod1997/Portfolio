...
export default function Header(){
   return(
    ...
    <div className="flex items-center gap-2">
      {/* Profile Icon */}
      <Image src="/Profilepic.jpg" alt="profile" className="rounded-full  object-cover w-20 h-20 border-2 border-gray-300" style={{ objectPosition: 'left' }} width={100} height={100} />
