...
export default function Header(){
  ...
  <div className="flex flex-col items-center gap-2 sm:flex-row sm:gap-4"> {/* Changed to flex-col for small screens */}
    {/* Profile Icon */}
    <Image
      src="/Profilepic.jpg"
      alt="profile"
  ...
  <p className="text-lg text-gray-100 dark:text-gray-300 text-center"> {/* Added text-center for centering */}
